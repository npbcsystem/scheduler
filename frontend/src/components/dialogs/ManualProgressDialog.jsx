...
import { addCompletedCourses } from "../../services/progressService";
...
export default function ManualProgressDialog({
  ...
  const handleSave = async () => {
    try {
      ...
      await addCompletedCourses(progressId, {
      ...
      alert(error.response?.data?.message || "Unable to update progress.");
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      <DialogTitle>Mark Course Complete</DialogTitle>

      <DialogContent>
        <Stack spacing={3} sx={{ mt: 1 }}>
          <Typography fontWeight="bold">Courses to Complete</Typography>
          ...
          <FormControl fullWidth>
            ...
            >
              <MenuItem value="">No Lecturer / Unknown</MenuItem>
